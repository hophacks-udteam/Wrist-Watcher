...
namespace Leap.Unity
{
    ...
    public class CapsuleHand : HandModelBase
    {
        ...
        public Vector3 getThumbBase()
        {
            return _spherePositions[THUMB_BASE_INDEX] - _hand.PalmPosition.ToVector3();
        }
        public Vector3 getMockThumbBase()
        {
            return  _hand.PalmPosition.ToVector3() + Vector3.Reflect(getThumbBase(), _hand.Basis.xBasis.ToVector3());
        }
